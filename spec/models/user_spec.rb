...
describe User do
  ...
  describe "folder associations" do
    ...
    before(:each) do
      @user = User.create(@attr)
      @fol1 = Factory(:folder, :user => @user, :name => "Charlie")
      @fol2 = Factory(:folder, :user => @user, :name => "Beta")
    end
    ...
    it "should have the right folders in the right order" do
      @user.folders.should == [@fol2, @fol1]
    end
  end
